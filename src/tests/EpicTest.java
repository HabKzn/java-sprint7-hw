...
class EpicTest {
    ...
    void createTasks() {
        ...
        SubTask sbt1 = new SubTask("sbt1", "this is subtask1", epc1, LocalDateTime.of(2023, 4, 17, 11, 0), Duration.ofMinutes(60));
        SubTask sbt2 = new SubTask("sbt2", "this is subtask2", epc1, LocalDateTime.of(2023, 4, 17, 13, 0), Duration.ofMinutes(60));
        SubTask sbt3 = new SubTask("sbt3", "this is subtask3", epc2, LocalDateTime.of(2023, 4, 17, 15, 0), Duration.ofMinutes(60));
        SubTask sbt4 = new SubTask("sbt4", "this is subtask4", epc2, LocalDateTime.of(2023, 4, 17, 17, 0), Duration.ofMinutes(60));
        SubTask sbt5 = new SubTask("sbt5", "this is subtask5", epc4, LocalDateTime.of(2023, 4, 17, 19, 0), Duration.ofMinutes(60));
        SubTask sbt6 = new SubTask("sbt6", "this is subtask6", epc4, LocalDateTime.of(2023, 4, 17, 21, 0), Duration.ofMinutes(60));
        SubTask sbt7 = new SubTask("sbt7", "this is subtask7", epc5, LocalDateTime.of(2023, 4, 17, 23, 0), Duration.ofMinutes(60));
        SubTask sbt8 = new SubTask("sbt8", "this is subtask8", epc5, LocalDateTime.of(2023, 4, 17, 9, 0), Duration.ofMinutes(60));
